...
SUNDIALS_DIR=../../../../SUMMA/SUNDIALS_install
export CMAKE_PREFIX_PATH="$SUNDIALS_DIR:$INSTALL_DIR/caf:$CMAKE_PREFIX_PATH"
...
export LIBRARY_LINKS="-m64;-L${MKLROOT}/lib;-Wl,--no-as-needed;-lmkl_gf_lp64;-lmkl_sequential;-lmkl_core;-lpthread;-lm;-ldl;-flto"

export FLAGS_OPT="-m64;-I"${MKLROOT}/include";-flto"   # optional compiler flags -- Intel oneMKL builds
